...
- [ ] 4. エージェントスロットシステムの実装
- [ ] 4.1 (P) SkillSlotConfig値オブジェクトの実装
  - スキルTypeIDとチェイン効果IDを保持
  - 空スロット判定メソッドの実装
  - _Requirements: 5.1, 5.2_

- [ ] 4.2 (P) AgentSlotドメインモデルの実装
  - コアTypeIDと選択レベルを保持
...
- [ ] 5. エージェントスロット管理ユースケースの実装
- [ ] 5.1 AgentSlotManagerの基本構造実装
  - 3つの固定スロット配列を管理
